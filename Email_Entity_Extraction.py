...
def main():
    ...
    analyzer = EmailAnalyzer(
        api_key="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",  # Replace with your actual Grok API key
        model="llama-3.2-90b-vision-preview"  # You can change this to another Grok model if needed
    )
